...
// promise с 4 выйдет первый, так как он позволяет асинхронным ребятам быть синхронными и там нет никаких задержек
// а сам setTimeOut будет последним, так как он сам по себе асинхронный - и выведет в конце 2